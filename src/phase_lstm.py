...
class PhasedLSTM(RNN):
    ...
    def build(self, input_shape):
        ...
        super(PhasedLSTM, self).build(input_shape)
...
get_custom_objects().update({'PhasedLSTMCell': PhasedLSTMCell})

# import tensorflow as tf
# model_PLSTM = tf.keras.Sequential()
# model_PLSTM.add(PhasedLSTMCell(32, input_shape=(28 * 28, 1), implementation=2))
